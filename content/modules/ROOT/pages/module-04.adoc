...
[link=../assets/Feb-06-2025_at_00.09.45-image.png]
image::../assets/Feb-06-2025_at_00.09.45-image.png[Create EDA Project,border=1]

*Step 6:* Wait for the project to show a green tick and *Completed* in the *Status* column, then move on to the next step.

[link=../assets/Feb-06-2025_at_00.10.57-image.png]
image::../assets/Feb-06-2025_at_00.10.57-image.png[Project Status Completed,border=1]
...
[link=../assets/Feb-06-2025_at_00.12.02-image.png]
image::../assets/Feb-06-2025_at_00.12.02-image.png[AAP Credential Configuration,border=1]
...
[link=../assets/Feb-05-2025_at_16.07.10-image.png]
image::../assets/Feb-05-2025_at_16.07.10-image.png[Rulebook Activation Running,border=1]
